...
#include "validation.h"                 // Crow Algo
#include "util.h"                       // Crow Algo
...
static const uint32_t MAINNET_CROW_MULTI_ACTIVATIONTIME = 2208988800;
static const uint32_t TESTNET_CROW_MULTI_ACTIVATIONTIME = 2208988800;
